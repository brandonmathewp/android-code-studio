...
import com.tom.rv2ide.interfaces.IEditorHandler
...
open class EditorHandlerActivity : ProjectHandlerActivity(), IEditorHandler {
  ...
  /**
   * Implementation of abstract doSaveFile method from BaseEditorActivity Uses the existing save
   * functionality in EditorHandlerActivity
   */
  override fun doSaveFile(editor: CodeEditorView): Boolean {
    return try {
      ...
      // Use runBlocking since this method isn't suspend but editor.save() is
